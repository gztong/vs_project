...
void FObjectCommandHandler::RegisterCommands()
{
	...
	Cmd = FDispatcherDelegate::CreateRaw(this, &FObjectCommandHandler::HellowWorld);
	Help = "Print Hello World";
	CommandDispatcher->BindCommand(TEXT("vget /object/hello"), Cmd, Help);
...
FExecStatus FObjectCommandHandler::HellowWorld(const TArray<FString>& Args)
{
	FString Msg;
	Msg += "Hello World!";
